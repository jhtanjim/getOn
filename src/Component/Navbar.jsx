      ...
      <div className="flex flex-col justify-center items-center w-full lg:px-10">
        <div className="navbar bg-base-100">
          <div className="navbar-start">
            ...
            <a className="text-3xl font-extrabold lg:ml-0 ml-10">GetOn</a>
          </div>
          ...
          <div className="navbar-end">
            <div className="flex items-center gap-4">
              <div className="dropdown dropdown-end">
                ...
                <div
                  tabIndex={0}
                  className="mt-3 z-[1] card card-compact dropdown-content w-52 bg-[#911e2b] shadow"
                >
                ...
                <label tabIndex={0} className="btn btn-ghost btn-circle avatar">
                  <div className="w-10 rounded-full">
                    <img
                      ...
                      src="https://pxbar.com/wp-content/uploads/2023/09/instagram-dp-boy-attitude-683x1024.jpg"
                    />
                  </div>
                </label>
                <ul
